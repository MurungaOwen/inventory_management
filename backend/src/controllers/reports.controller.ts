...
export class ReportsController {
  ...
  public getMonthlyReport = asyncHandler(async (req: Request, res: Response) => {
  ...
  public getCustomRangeReport = asyncHandler(async (req: Request, res: Response) => {
    ...
    const report = await this.reportsService.getCustomRangeReport(startDate, endDate);
